...
import * as Analytics from "components/modal/components/activity/Activity";
    ...
    <div className={styles.sort}>
      <button
        ...
        style={
          sort.self
            ? {
                background: setting?.analytics?.color.self || "#49b657",
      ...
      <button
        ...
        style={
          sort.others
            ? {
                background: setting?.analytics?.color.others || "#ff9900",
